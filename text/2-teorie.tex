...
\begin{figure}[H]
    ...
    \includegraphics[scale=0.6]{./pictures/vuzSURO.jpg}
      	\caption[Vůz \zk{MS} \zk{SÚRO} Praha]{Vůz \zk{MS} \zk{SÚRO} Praha (zdroj: SÚRO, v.v.i.)}
    	\label{fig:vuzSURO}
\end{figure} 
